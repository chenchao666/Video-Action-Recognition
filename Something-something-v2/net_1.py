...
class InceptionI3d(snt.AbstractModule):
  ...
  def __init__(self, num_classes=174, spatial_squeeze=True,
  ...
  def _build(self, inputs, is_training, dropout_keep_prob=1.0):
    ...
    net = Unit3D(output_channels=64, kernel_shape=[1, 7, 7], stride=[1, 2, 2], name='Conv3d_1a_1x7x7')(net, is_training=is_training)
    net = Unit3D(output_channels=64, kernel_shape=[7, 1, 1], stride=[1, 1, 1], name='Conv3d_1a_7x1x1')(net,is_training=is_training)
    ...
    net = Unit3D(output_channels=192, kernel_shape=[1, 3, 3],name='Conv3d_2c_1x3x3')(net, is_training=is_training)
    net = Unit3D(output_channels=192, kernel_shape=[3, 1, 1], name='Conv3d_2c_3x1x1')(net, is_training=is_training)
    end_points[end_point] = net
    if self._final_endpoint == end_point: return net, end_points
    ...
    with tf.variable_scope(end_point):
      ...
      with tf.variable_scope('Branch_1'):
        ...
        branch_1 = Unit3D(output_channels=128, kernel_shape=[1, 3, 3],name='Conv3d_0b_3x3')(branch_1,is_training=is_training)
      with tf.variable_scope('Branch_2'):
        branch_2 = Unit3D(output_channels=16, kernel_shape=[1, 1, 1],name='Conv3d_0a_1x1')(net, is_training=is_training)
        branch_2 = Unit3D(output_channels=32, kernel_shape=[1, 3, 3],name='Conv3d_0b_3x3')(branch_2,is_training=is_training)
      ...
      net = self.DilaConv(net, num_filters=[196,128,64],is_training=is_training)
      net = Unit3D(output_channels=192, kernel_shape=[1, 1, 1])(net, is_training=is_training)
      net = net + end_points['MaxPool3d_3a_3x3']
    end_points[end_point] = net
    if self._final_endpoint == end_point: return net, end_points
    ...
    with tf.variable_scope(end_point):
      ...
      with tf.variable_scope('Branch_1'):
        ...
        branch_1 = Unit3D(output_channels=192, kernel_shape=[1, 3, 3],name='Conv3d_0b_3x3')(branch_1,is_training=is_training)
      with tf.variable_scope('Branch_2'):
        branch_2 = Unit3D(output_channels=32, kernel_shape=[1, 1, 1],name='Conv3d_0a_1x1')(net, is_training=is_training)
        branch_2 = Unit3D(output_channels=96, kernel_shape=[1, 3, 3],name='Conv3d_0b_3x3')(branch_2,is_training=is_training)
      with tf.variable_scope('Branch_3'):
        branch_3 = tf.nn.max_pool3d(net, ksize=[1, 3, 3, 3, 1],strides=[1, 1, 1, 1, 1], padding=snt.SAME,name='MaxPool3d_0a_3x3')
        branch_3 = Unit3D(output_channels=64, kernel_shape=[1, 1, 1],name='Conv3d_0b_1x1')(branch_3,is_training=is_training)
      net = tf.concat([branch_0, branch_1, branch_2, branch_3], 4)
      # net = self.DilaConv(net, num_filters=[256, 128, 64],is_training=is_training)
      net = Unit3D(output_channels=192, kernel_shape=[1, 1, 1])(net, is_training=is_training)
      net = net + end_points['Mixed_3b']
    end_points[end_point] = net
    if self._final_endpoint == end_point: return net, end_points


    end_point = 'MaxPool3d_4a_3x3'
    net = tf.nn.max_pool3d(net, ksize=[1, 3, 3, 3, 1], strides=[1, 2, 2, 2, 1], padding=snt.SAME, name=end_point)  # strides=[1, 2, 2, 2, 1]
    end_points[end_point] = net
    if self._final_endpoint == end_point: return net, end_points

    with tf.variable_scope('ST_1'):
        net = ST_Attention(net,Pooling_size=[1,1,1,1,1])
    ...
    with tf.variable_scope(end_point):
      ...
      with tf.variable_scope('Branch_1'):
        branch_1 = Unit3D(output_channels=96, kernel_shape=[1, 1, 1],name='Conv3d_0a_1x1x1')(net, is_training=is_training)
        branch_1 = Unit3D(output_channels=208, kernel_shape=[1, 3, 3],name='Conv3d_0b_1x3x3')(branch_1,is_training=is_training)
        branch_1 = Unit3D(output_channels=128, kernel_shape=[3, 1, 1], name='Conv3d_0b_3x1x1')(branch_1,is_training=is_training)
      with tf.variable_scope('Branch_2'):
        branch_2 = Unit3D(output_channels=16, kernel_shape=[1, 1, 1],name='Conv3d_0a_1x1')(net, is_training=is_training)
        branch_2 = Unit3D(output_channels=48, kernel_shape=[1, 3, 3],name='Conv3d_0b_1x3x3')(branch_2,is_training=is_training)
        branch_2 = Unit3D(output_channels=48, kernel_shape=[3, 1, 1], name='Conv3d_0b_3x1x1')(branch_2,is_training=is_training)
      with tf.variable_scope('Branch_3'):
        branch_3 = tf.nn.max_pool3d(net, ksize=[1, 3, 3, 3, 1],strides=[1, 1, 1, 1, 1], padding=snt.SAME,name='MaxPool3d_0a_3x3')
        branch_3 = Unit3D(output_channels=64, kernel_shape=[1, 1, 1],name='Conv3d_0b_1x1')(branch_3,is_training=is_training)
      net = tf.concat([branch_0, branch_1, branch_2, branch_3], 4)
      # net = self.DilaConv(net, num_filters=[192, 128, 64],is_training=is_training)
      net = Unit3D(output_channels=192, kernel_shape=[1, 1, 1])(net, is_training=is_training)
      net = net + end_points['MaxPool3d_4a_3x3']
    end_points[end_point] = net
    if self._final_endpoint == end_point: return net, end_points
    ...
    with tf.variable_scope(end_point):
      ...
      with tf.variable_scope('Branch_1'):
        ...
        branch_1 = Unit3D(output_channels=224, kernel_shape=[1, 3, 3],name='Conv3d_0b_1x3x3')(branch_1,is_training=is_training)
        branch_1 = Unit3D(output_channels=112, kernel_shape=[3, 1, 1], name='Conv3d_0b_3x1x1')(branch_1,is_training=is_training)
      with tf.variable_scope('Branch_2'):
        branch_2 = Unit3D(output_channels=24, kernel_shape=[1, 1, 1],name='Conv3d_0a_1x1')(net, is_training=is_training)
        branch_2 = Unit3D(output_channels=64, kernel_shape=[1, 3, 3],name='Conv3d_0b_1x3x3')(branch_2,is_training=is_training)
        branch_2 = Unit3D(output_channels=64, kernel_shape=[3, 1, 1], name='Conv3d_0b_3x1x1')(branch_2,is_training=is_training)
      with tf.variable_scope('Branch_3'):
        branch_3 = tf.nn.max_pool3d(net, ksize=[1, 3, 3, 3, 1],strides=[1, 1, 1, 1, 1], padding=snt.SAME,name='MaxPool3d_0a_3x3')
        branch_3 = Unit3D(output_channels=64, kernel_shape=[1, 1, 1],name='Conv3d_0b_1x1')(branch_3,is_training=is_training)
      net = tf.concat([branch_0, branch_1, branch_2, branch_3], 4)
    ...
    with tf.variable_scope(end_point):
      ...
      with tf.variable_scope('Branch_1'):
        branch_1 = Unit3D(output_channels=128, kernel_shape=[1, 1, 1],name='Conv3d_0a_1x1')(net, is_training=is_training)
        branch_1 = Unit3D(output_channels=256, kernel_shape=[1, 3, 3],name='Conv3d_0b_3x3')(branch_1,is_training=is_training)
        branch_1 = Unit3D(output_channels=128, kernel_shape=[3, 1, 1], name='Conv3d_0b_3x3')(branch_1,is_training=is_training)
      with tf.variable_scope('Branch_2'):
        branch_2 = Unit3D(output_channels=24, kernel_shape=[1, 1, 1],name='Conv3d_0a_1x1')(net, is_training=is_training)
        branch_2 = Unit3D(output_channels=64, kernel_shape=[1, 3, 3],name='Conv3d_0b_1x3x3')(branch_2,is_training=is_training)
        branch_2 = Unit3D(output_channels=64, kernel_shape=[3, 1, 1], name='Conv3d_0b_3x1x1')(branch_2,is_training=is_training)
    ...
    with tf.variable_scope(end_point):
      ...
      with tf.variable_scope('Branch_1'):
        ...
        branch_1 = Unit3D(output_channels=288, kernel_shape=[1, 3, 3],name='Conv3d_0b_1x3x3')(branch_1,is_training=is_training)
        branch_1 = Unit3D(output_channels=144, kernel_shape=[3, 1, 1], name='Conv3d_0b_3x1x1')(branch_1,is_training=is_training)
      with tf.variable_scope('Branch_2'):
        branch_2 = Unit3D(output_channels=32, kernel_shape=[1, 1, 1],name='Conv3d_0a_1x1')(net, is_training=is_training)
        branch_2 = Unit3D(output_channels=64, kernel_shape=[1, 3, 3],name='Conv3d_0b_1x3x3')(branch_2,is_training=is_training)
        branch_2 = Unit3D(output_channels=64, kernel_shape=[3, 1, 1], name='Conv3d_0b_3x1x1')(branch_2,is_training=is_training)
    ...
    with tf.variable_scope(end_point):
      ...
      with tf.variable_scope('Branch_1'):
        ...
        branch_1 = Unit3D(output_channels=320, kernel_shape=[1, 3, 3],name='Conv3d_0b_1x3x3')(branch_1,is_training=is_training)
        branch_1 = Unit3D(output_channels=160, kernel_shape=[3, 1, 1], name='Conv3d_0b_3x1x1')(branch_1,is_training=is_training)
      with tf.variable_scope('Branch_2'):
        branch_2 = Unit3D(output_channels=32, kernel_shape=[1, 1, 1],name='Conv3d_0a_1x1')(net, is_training=is_training)
        branch_2 = Unit3D(output_channels=128, kernel_shape=[1, 3, 3],name='Conv3d_0b_1x3x3')(branch_2,is_training=is_training)
        branch_2 = Unit3D(output_channels=64, kernel_shape=[3, 1, 1], name='Conv3d_0b_3x1x1')(branch_2,is_training=is_training)
      with tf.variable_scope('Branch_3'):
        branch_3 = tf.nn.max_pool3d(net, ksize=[1, 3, 3, 3, 1],strides=[1, 1, 1, 1, 1], padding=snt.SAME,name='MaxPool3d_0a_3x3')
      ...
      net = self.DilaConv(net, num_filters=[256, 128, 64],is_training=is_training)
      net = Unit3D(output_channels=192, kernel_shape=[1, 1, 1])(net, is_training=is_training)
      net = net + end_points['Mixed_4e']
    end_points[end_point] = net
    if self._final_endpoint == end_point: return net, end_points

    with tf.variable_scope('ST_3'):
        net = ST_Attention(net, Pooling_size=[1, 1, 1, 1, 1])
    ...
    with tf.variable_scope(end_point):
      ...
      with tf.variable_scope('Branch_2'):
        branch_2 = Unit3D(output_channels=32, kernel_shape=[1, 1, 1],name='Conv3d_0a_1x1')(net, is_training=is_training)
        branch_2 = Unit3D(output_channels=128, kernel_shape=[1, 3, 3],name='Conv3d_0a_1x3x3')(branch_2,is_training=is_training)
        branch_2 = Unit3D(output_channels=64, kernel_shape=[3, 1, 1],name='Conv3d_0a_3x1x1')(branch_2,is_training=is_training)
      with tf.variable_scope('Branch_3'):
        branch_3 = tf.nn.max_pool3d(net, ksize=[1, 3, 3, 3, 1],strides=[1, 1, 1, 1, 1], padding=snt.SAME,name='MaxPool3d_0a_3x3')
        branch_3 = Unit3D(output_channels=128, kernel_shape=[1, 1, 1],name='Conv3d_0b_1x1')(branch_3,is_training=is_training)
      net = tf.concat([branch_0, branch_1, branch_2, branch_3], 4)
      # net = self.DilaConv(net, num_filters=[192, 128, 64],is_training=is_training)
      net = Unit3D(output_channels=192, kernel_shape=[1, 1, 1])(net, is_training=is_training)
      net = net + end_points['MaxPool3d_5a_2x2']
    end_points[end_point] = net
    if self._final_endpoint == end_point: return net, end_points
    ...
    with tf.variable_scope(end_point):
      ...
      with tf.variable_scope('Branch_1'):
        ...
        branch_1 = Unit3D(output_channels=384, kernel_shape=[1, 3, 3],name='Conv3d_0b_1x3x3')(branch_1,is_training=is_training)
        branch_1 = Unit3D(output_channels=192, kernel_shape=[3, 1, 1], name='Conv3d_0b_3x1x1')(branch_1,is_training=is_training)
      with tf.variable_scope('Branch_2'):
...
#####################################################################################################
    ...
    end_point = 'Logits'
    with tf.variable_scope(end_point):
        net = tf.nn.avg_pool3d(net, ksize=[1, 3, 3, 3, 1],strides=[1, 1, 1, 1, 1], padding=snt.VALID)
        net = tf.nn.dropout(net, dropout_keep_prob)
        averaged_logits = self.Bilinear_Pooling(net)
        averaged_logits = tf.layers.dense(averaged_logits, self._num_classes, use_bias=True)
...
#########################################################################################################
  ...
  def DilaConv(self,net,num_filters=[256,128,64],is_training=True):
      net=tf.layers.conv3d(net, filters=128, kernel_size=[1, 1, 1], strides=[1, 1, 1],padding='SAME')
      with tf.variable_scope('Branch_1'):
          branch_1 = tf.layers.conv3d(net, filters=num_filters[0], kernel_size=[3, 1, 1], strides=[1, 1, 1],padding='SAME',dilation_rate=(1, 1, 1), name='dilation')
          branch_1 = tf.layers.batch_normalization(branch_1,training=is_training)
          branch_1 = tf.nn.relu(branch_1)
      with tf.variable_scope('Branch_2'):
          branch_2 = tf.layers.conv3d(net, filters=num_filters[1], kernel_size=[3, 1, 1], strides=[1, 1, 1],padding='SAME',dilation_rate=(2, 1, 1), name='dilation')
          branch_2 = tf.layers.batch_normalization(branch_2, training=is_training)
          branch_2 = tf.nn.relu(branch_2)
      with tf.variable_scope('Branch_3'):
          branch_3 = tf.layers.conv3d(net, filters=num_filters[2], kernel_size=[3, 1, 1], strides=[1, 1, 1], padding='SAME',dilation_rate=(4, 1, 1), name='dilation')
          branch_3 = tf.layers.batch_normalization(branch_3, training=is_training)
          branch_3 = tf.nn.relu(branch_3)
      net=tf.concat([branch_1,branch_2,branch_3],axis=4)
      return net
