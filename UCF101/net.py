...
class InceptionI3d(snt.AbstractModule):
  ...
  def _build(self, inputs, is_training, dropout_keep_prob=1.0):
    ...
    net = Unit3D(output_channels=64, kernel_shape=[7, 7, 7],stride=[1, 2, 2], name=end_point)(net, is_training=is_training)   #[2,2,2]
    ...
    with tf.variable_scope(end_point):
      ...
      with tf.variable_scope('Branch_1'):
        ...
        # branch_1 = tf.layers.conv3d(branch_1, filters=192, kernel_size=[3, 1, 1], strides=[1, 1, 1], padding='SAME',dilation_rate=(2, 1, 1), activation=tf.nn.relu, name='dilation')
      with tf.variable_scope('Branch_2'):
        ...
        # branch_2 = tf.layers.conv3d(branch_2, filters=96, kernel_size=[3, 1, 1], strides=[1, 1, 1], padding='SAME',dilation_rate=(3, 1, 1), activation=tf.nn.relu, name='dilation')
      with tf.variable_scope('Branch_3'):
        branch_3 = tf.nn.max_pool3d(net, ksize=[1, 3, 3, 3, 1],strides=[1, 1, 1, 1, 1], padding=snt.SAME,name='MaxPool3d_0a_3x3')
    ...
    with tf.variable_scope(end_point):
      ...
      with tf.variable_scope('Branch_1'):
        ...
        # branch_1 = tf.layers.conv3d(branch_1, filters=224, kernel_size=[3, 1, 1], strides=[1, 1, 1], padding='SAME',dilation_rate=(2, 1, 1), activation=tf.nn.relu, name='dilation')
      with tf.variable_scope('Branch_2'):
        ...
        # branch_2 = tf.layers.conv3d(branch_2, filters=64, kernel_size=[3, 1, 1], strides=[1, 1, 1], padding='SAME',dilation_rate=(3, 1, 1), activation=tf.nn.relu, name='dilation')
      with tf.variable_scope('Branch_3'):
        branch_3 = tf.nn.max_pool3d(net, ksize=[1, 3, 3, 3, 1],strides=[1, 1, 1, 1, 1], padding=snt.SAME,name='MaxPool3d_0a_3x3')
        branch_3 = Unit3D(output_channels=64, kernel_shape=[1, 1, 1],name='Conv3d_0b_1x1')(branch_3,is_training=is_training)
      net = tf.concat([branch_0, branch_1, branch_2, branch_3], 4)
    ...
    with tf.variable_scope(end_point):
      ...
      with tf.variable_scope('Branch_1'):
        ...
        # branch_1 = tf.layers.conv3d(branch_1, filters=256, kernel_size=[3, 1, 1], strides=[1, 1, 1], padding='SAME',dilation_rate=(2, 1, 1), activation=tf.nn.relu, name='dilation')
      with tf.variable_scope('Branch_2'):
        branch_2 = Unit3D(output_channels=24, kernel_shape=[1, 1, 1],name='Conv3d_0a_1x1')(net, is_training=is_training)
        branch_2 = Unit3D(output_channels=64, kernel_shape=[3, 3, 3],name='Conv3d_0b_3x3')(branch_2,is_training=is_training)
        # branch_2 = tf.layers.conv3d(branch_2, filters=64, kernel_size=[3, 1, 1], strides=[1, 1, 1], padding='SAME',dilation_rate=(3, 1, 1), activation=tf.nn.relu, name='dilation')
    ...
    with tf.variable_scope(end_point):
      ...
      with tf.variable_scope('Branch_1'):
        ...
        # branch_1 = tf.layers.conv3d(branch_1, filters=288, kernel_size=[3, 1, 1], strides=[1, 1, 1], padding='SAME',dilation_rate=(2, 1, 1), activation=tf.nn.relu, name='dilation')
      with tf.variable_scope('Branch_2'):
        branch_2 = Unit3D(output_channels=32, kernel_shape=[1, 1, 1],name='Conv3d_0a_1x1')(net, is_training=is_training)
        branch_2 = Unit3D(output_channels=64, kernel_shape=[3, 3, 3],name='Conv3d_0b_3x3')(branch_2,is_training=is_training)
        # branch_2 = tf.layers.conv3d(branch_2, filters=64, kernel_size=[3, 1, 1], strides=[1, 1, 1], padding='SAME',dilation_rate=(3, 1, 1), activation=tf.nn.relu, name='dilation')
    ...
    with tf.variable_scope(end_point):
      ...
      with tf.variable_scope('Branch_1'):
        ...
        # branch_1 = tf.layers.conv3d(branch_1, filters=320, kernel_size=[3, 1, 1], strides=[1, 1, 1], padding='SAME',dilation_rate=(2, 1, 1), activation=tf.nn.relu, name='dilation')
      with tf.variable_scope('Branch_2'):
        branch_2 = Unit3D(output_channels=32, kernel_shape=[1, 1, 1],name='Conv3d_0a_1x1')(net, is_training=is_training)
        branch_2 = Unit3D(output_channels=128, kernel_shape=[3, 3, 3],name='Conv3d_0b_3x3')(branch_2,is_training=is_training)
        # branch_2 = tf.layers.conv3d(branch_2, filters=128, kernel_size=[3, 1, 1], strides=[1, 1, 1], padding='SAME',dilation_rate=(3, 1, 1), activation=tf.nn.relu, name='dilation')
      with tf.variable_scope('Branch_3'):
        branch_3 = tf.nn.max_pool3d(net, ksize=[1, 3, 3, 3, 1],strides=[1, 1, 1, 1, 1], padding=snt.SAME,name='MaxPool3d_0a_3x3')
    ...
    with tf.variable_scope(end_point):
      ...
      with tf.variable_scope('Branch_1'):
        ...
        # branch_1 = tf.layers.conv3d(branch_1, filters=384, kernel_size=[3, 1, 1], strides=[1, 1, 1],padding='SAME',dilation_rate=(2, 1, 1), activation=tf.nn.relu, name='dilation')
      with tf.variable_scope('Branch_2'):
      ...
      with tf.variable_scope('Branch_3'):
        branch_3 = tf.nn.max_pool3d(net, ksize=[1, 3, 3, 3, 1],strides=[1, 1, 1, 1, 1], padding=snt.SAME,name='MaxPool3d_0a_3x3')
        branch_3 = Unit3D(output_channels=128, kernel_shape=[1, 1, 1],name='Conv3d_0b_1x1')(branch_3,is_training=is_training)
        # branch_3 = tf.layers.conv3d(branch_3, filters=128, kernel_size=[3, 1, 1], strides=[1, 1, 1],padding='SAME',dilation_rate=(4, 1, 1), activation=tf.nn.relu, name='dilation')
      net = tf.concat([branch_0, branch_1, branch_2, branch_3], 4)
    end_points[end_point] = net
    if self._final_endpoint == end_point: return net, end_points
...
##################################################################################################
    end_point = 'Logits'
    with tf.variable_scope(end_point):
      net = tf.nn.avg_pool3d(net, ksize=[1, 6, 7, 7, 1],      #[1,2,7,7,1]
...
#####################  Add 2D Conv in the Network ###########################################
        # Net0=tf.layers.conv3d(end_points['Mixed_4f'],filters=256,kernel_size=[3,1,1],strides=[1,1,1],dilation_rate=(1, 1, 1),activation=tf.nn.relu,name='conv11')
        # Net1 = tf.layers.conv3d(end_points['Mixed_4f'], filters=256, kernel_size=[3, 1, 1], strides=[1, 1, 1],dilation_rate=(2, 1, 1), activation=tf.nn.relu, name='conv12')
        # Net2 = tf.layers.conv3d(end_points['Mixed_4f'], filters=256, kernel_size=[3, 1, 1], strides=[1, 1, 1],dilation_rate=(4, 1, 1), activation=tf.nn.relu, name='conv13')
        # Net=tf.concat([Net0,Net1,Net2],3)
        # Net = tf.layers.conv3d(Net, filters=512,kernel_size=[1, 1,1], strides=[1, 1,1], name='conv1')
        # # Net=tf.layers.batch_normalization(Net,training=is_training)
        # Net=tf.layers.max_pooling3d(Net,pool_size=[1,2,2],strides=[1,1,1])
        # Net0 = tf.layers.conv3d(Net, filters=256, kernel_size=[3, 1, 1], strides=[1, 1, 1],dilation_rate=(1, 1, 1), activation=tf.nn.relu, name='conv21')
        # Net1 = tf.layers.conv3d(Net, filters=256, kernel_size=[3, 1, 1], strides=[1, 1, 1],dilation_rate=(2, 1, 1), activation=tf.nn.relu, name='conv22')
        # Net2 = tf.layers.conv3d(Net, filters=256, kernel_size=[3, 1, 1], strides=[1, 1, 1],dilation_rate=(4, 1, 1), activation=tf.nn.relu, name='conv23')
        # Net = tf.concat([Net0, Net1, Net2], 3)
        # # Net = tf.layers.batch_normalization(Net, training=is_training)
        # Net = tf.layers.max_pooling2d(Net, pool_size=[4, 6], strides=[2, 2])
